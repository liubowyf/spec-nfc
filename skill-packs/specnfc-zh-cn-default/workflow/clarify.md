...
- `澄清确认记录`：必须有最近一次确认问题、用户答复摘要、确认状态和待确认项
...
- **选择确认**：在写 `当前选择` 前，必须显式询问“是否按该选择推进”
...
- strict：`问题定义 / 非目标 / 当前选择 / 澄清确认记录 / 验收口径` 未闭合时软阻断阶段推进。
